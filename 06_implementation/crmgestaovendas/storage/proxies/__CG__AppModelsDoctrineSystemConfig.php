 ...
 */
class SystemConfig extends \App\Models\Doctrine\SystemConfig implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'config_id' => [parent::class, 'config_id', null, 16],
        "\0".parent::class."\0".'config_key' => [parent::class, 'config_key', null, 16],
        "\0".parent::class."\0".'config_value' => [parent::class, 'config_value', null, 16],
        ...
        'config_id' => [parent::class, 'config_id', null, 16],
        'config_key' => [parent::class, 'config_key', null, 16],
        'config_value' => [parent::class, 'config_value', null, 16],

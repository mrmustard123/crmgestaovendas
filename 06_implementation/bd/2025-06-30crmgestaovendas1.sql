...
CREATE TABLE `users_group` (
  `user_group_id` tinyint(4) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `functionality` (
  `functionality_id` tinyint(4) unsigned  NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `directive` (
  `directive_id` tinyint(4) unsigned  NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `person_role` (
  `person_role_id` tinyint(4) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
INSERT INTO `person_role` VALUES ('1', 'Lead', '2025-06-29 12:03:21', '2025-06-29 12:03:21');
INSERT INTO `person_role` VALUES ('2', 'Cliente', '2025-06-29 12:03:21', '2025-06-29 12:03:21');
INSERT INTO `person_role` VALUES ('3', 'Contato', '2025-06-29 12:03:21', '2025-06-29 12:03:21');
...
CREATE TABLE `opportunity_status` (
  `opportunity_status_id` tinyint(4) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `opportunity` (
  ...
  `lead_origin_id` tinyint(4) unsigned DEFAULT NULL,
  `priority` enum('Low','Medium','High','Critical') NOT NULL DEFAULT 'Low',
  `fk_op_status_id` tinyint(4) unsigned DEFAULT NULL,
  `fk_vendor` int(11) unsigned DEFAULT NULL,
  `fk_person` int(11) unsigned DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `product_service` (
  `product_service_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `prod_serv_opp` (
  `oportunity_id` int(11) unsigned NOT NULL,
...
CREATE TABLE `stage` (
  `stage_id` tinyint(4) unsigned NOT NULL AUTO_INCREMENT,
